  ...
  return (
    <>
      <header className="flex h-14 sm:h-16 shrink-0 items-center gap-1 sm:gap-2 border-b px-2 sm:px-4">
        ...
        {/* Org Switcher - hidden on very small screens */}
        <OrgSwitcher className="hidden sm:flex w-[140px] md:w-[180px] lg:w-[200px]" />
        ...
        <Button
          variant="outline"
          className="relative h-8 w-8 sm:h-9 sm:w-9 p-0 md:h-9 md:w-48 lg:w-60 md:justify-start md:px-3 md:py-2"
          onClick={() => setCommandOpen(true)}
        >
          <Search className="h-4 w-4 md:mr-2" />
          <span className="hidden md:inline-flex">Search...</span>
          <kbd className="pointer-events-none absolute right-1.5 top-1.5 sm:top-2 hidden h-5 select-none items-center gap-1 rounded border bg-muted px-1.5 font-mono text-[10px] font-medium opacity-100 lg:flex">
